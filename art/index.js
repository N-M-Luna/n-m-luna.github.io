...
function openShop() {
    ...
    printsCatalogue.forEach(item => {
        ...
        if (item['prints8x10'] !==  0) {
            ...
            priceStrss.push(`<a href='https://www.etsy.com/listing/${item.etsyURL}' target='_blank'>8 x 10 inch print ${avail} for \$45</a>`)
        }
        if (item['prints9x12'] !==  0) {
            avail = item['prints9x12'] < 0 ? 'sold' : 'available'
            priceStrss.push(`<a href='https://www.etsy.com/listing/${item.etsyURL}' target='_blank'>9 x 12 inch print ${avail} for \$70</a>`)
        }
        let redBubPtag = ''
